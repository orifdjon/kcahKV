...
const Basket = ({match: {params: {areaId, itemId}}, foodAreas, order}) => {
    const [faster, setFaster] = useState(JSON.parse(localStorage.getItem('faster') || 'true'));
    const [time, setTime] = useState(localStorage.getItem('time') || '');
    const [selfService, setSelfService] = useState(JSON.parse(localStorage.getItem('self') || 'false'));
            ...
            <div className="Place__choice">
                ...
                <div className="Place__choice-item">
                    ...
                    <Checkbox checked={selfService} onToggle={() => {
                        localStorage.setItem('self', JSON.stringify(!selfService));
